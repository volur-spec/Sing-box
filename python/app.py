...
config = {
    'UUID': os.environ.get('UUID', '056ef337-6710-434e-8973-6ee871609598'), # 节点UUID，使用哪吒v1时在不不同的平台部署需要修改，否则agent会覆盖
    ...
    'ARGO_DOMAIN': os.environ.get('ARGO_DOMAIN', 'www23.volur.kdns.fr'),   # 固定隧道域名,留空即启用临时隧道
    'ARGO_AUTH': os.environ.get('ARGO_AUTH', 'eyJhIjoiYTk0MjkxMjkzOTUwYTBiNDFhNWUzNTM3NzFmNzE2ZGYiLCJ0IjoiMDU2ZWYzMzctNjcxMC00MzRlLTg5NzMtNmVlODcxNjA5NTk4IiwicyI6Ik0ySXlaVGhqWW1RdE5UTTRaUzAwWTJZekxXRmxaV1F0Tm1SaFlXSTVZbUkxTURBMiJ9'),       # 固定隧道token或json,留空即启用临时隧道,json获取:https://json.zone.id
